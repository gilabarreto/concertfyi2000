    ...
    >
      {status === "loading" && (
        <div className="space-y-5">
          ...
          <p className="text-gray-800">Connecting to Spotify...</p>
        </div>
      )}
      ...
      {status === "success" && (
        <div className="space-y-2">
          ...
          <p className="text-sm text-gray-500">Creating your playlist...</p>
        </div>
      )}
      ...
      {status === "error" && (
        <div className="space-y-2">
          ...
          <p className="font-semibold text-gray-800">Authentication failed</p>

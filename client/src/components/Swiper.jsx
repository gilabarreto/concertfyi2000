      ...
      {slides.map((slide, i) => {
        ...
        return (
          <div
            ...
            className="absolute top-10 -translate-x-1/2 w-[500px] aspect-video rounded-xl overflow-hidden border-4 border-transparent transition-all duration-300 hover:border-zinc-800 cursor-pointer"
            style={style}
          >
